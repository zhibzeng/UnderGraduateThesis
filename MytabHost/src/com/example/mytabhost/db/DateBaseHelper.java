   ...
   private static final String DATABASE_NAME = "autoComplete4.db";
    ...
    public void onCreate(SQLiteDatabase db) {
       ...
       String[] nameStrArrayStr = new String[] {
    		   //内环
        "龙腾东路出口", "丽都路口入口", "创业路入口","创业路出口","人南立交出口","人南立交入口","科华中路出口","科华中路入口","琉璃路出口","锦华路出口",
        "龙舟路入口","东大路出口","双庆桥出口","万年桥出口","东篱路入口","衫板桥立交出口","衫板桥立交入口","建设路出口","春木林入口","府青路出口",
        "刃具立交入口","解放路出口","高笋塘入口","北新干道出口","北新干道入口","火车北站入口","九里堤出口","银沙路入口","茶店子出口","清溪西路入口",
        //外环
       "大石西路出口","家园南路入口","抚琴西路出口","营兴街入口","茶店子出口","沙湾路出口","府河市场入口","北站东二路出口","北星大道出口","北新干道入口",
       "红花北路入口","府青路出口","府青路入口","建设路出口","杉板桥路出口","杉板桥路入口","双林北支路入口","双庆路 双桥路出口","牛市口入口","龙舟路出口",
       "莲桂东路入口","净居寺路出口","科华中路出口","人民南路出口","玉林南街入口","创业路出口","创业路入口","高升桥路 出口","红牌楼路入口","武侯大道出口",
       "成温立交入口",

       //内环
       "双轿子立交桥北站","双娇子立交桥南站","牛市口站","桂莲东路口站","龙舟路口站","成仁公交站","东湖公园站","科华路口站","人南立交东站","紫荆北路口站",
       "红牌楼东站","红牌楼西站","少陵路口站","清水河站","光华村西口站","府南新区站","蜀汉路口北站","营门口北站","西南交大站","商贸大道口站",
       "火车北站东站","三友路口站","桃蹊路口站","建设路口站","建设南口路站","杉板桥站","双林北支路路口站","万年场站",
       
       //外环
       "建设南路口站","建设路口站","桃蹊路口站","三友路口站","高笋塘站","火车北站西站","商贸大道口站","西南交大站","营门口北",
