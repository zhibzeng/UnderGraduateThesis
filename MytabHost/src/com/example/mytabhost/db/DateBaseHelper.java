   ...
   private static final String DATABASE_NAME = "autoComplete4.db";
    ...
    public void onCreate(SQLiteDatabase db) {
       ...
       String[] nameStrArrayStr = new String[] {
        ...
        "东大路出口","双桂路入口","双桂路出口","双庆路出口","万年路出口","杉板桥路出口","杉板桥路入口","建设北路出口","府青路出口",
        "驷马桥路入口","驷马桥街出口","北星干道出口","北星干道入口","火车北站入口","九里堤出口","银沙路入口","茶店子出口","清溪西路入口",
        //内环 30
       "大石西路出口","家园南路入口","抚琴西路出口","营兴街入口","茶店子出口","沙湾路出口","府河市场入口","北站东二路出口","北星大道出口","北星干道入口",
