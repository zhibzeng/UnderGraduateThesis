...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
       ...
       mTabHost.setPadding(mTabHost.getPaddingLeft(),
        ...
        layout2spec.setIndicator("交通公告",realDrawable2);
        ...
        layout3spec.setIndicator("设置",realDrawable3);
        ...
        layout4spec.setIndicator("公交",realDrawable4);
...
//        mTabHost.addTab(layout5spec);
        ...
        layout5spec.setIndicator("应用",realDrawable5);
        layout5spec.setContent(layout5intent);
        mTabHost.addTab(layout5spec);
